-- Adds "discord" and "tumblr" as valid platform values, same pattern as
-- 0019_threads_platform.sql / 0020_facebook_instagram_platform.sql.
...
alter table oauth_states add constraint oauth_states_platform_check
  check (platform in ('meta', 'tiktok', 'pinterest', 'youtube', 'mastodon', 'bluesky', 'telegram', 'linkedin', 'threads', 'facebook', 'instagram', 'discord', 'tumblr'));
