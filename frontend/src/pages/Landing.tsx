    ...
    <div className="landing">
      <div className="circuit-background" aria-hidden="true">
        <svg className="circuit-svg" viewBox="0 0 1600 1000" preserveAspectRatio="xMidYMid slice" role="presentation">
          ...
          {/* Signals — only a few routes carry current at a time */}
          ...
          <path className="pulse pulse-2" pathLength={1000} d="M1600 470H1490V545H1392V618H1295" />
          <circle className="confirmation-ring ring-2" cx="1295" cy="618" r="8" />
          <circle className="confirmation-dot dot-2" cx="1295" cy="618" r="2.4" />

          <path className="pulse pulse-3" pathLength={1000} d="M0 930H165V865H280V805H390" />
          <circle className="confirmation-ring ring-3" cx="390" cy="805" r="8" />
          <circle className="confirmation-dot dot-3" cx="390" cy="805" r="2.4" />

          <path className="pulse pulse-4 desktop-only" pathLength={1000} d="M1600 245H1510V310H1415V372H1325" />
        </svg>
      </div>
